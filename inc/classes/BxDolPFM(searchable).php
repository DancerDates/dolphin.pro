...
class BxDolPFM
{
    ...
    function genFormAdvTab( $aField )
    {
	    ...
	    'Searchable' => array(
			'label'  => 'Searchable',
			'type'   => 'checkbox',
			'info'   => 'Indicates whether this field can be searchable from a profile view page.',
			'value'  => $aField['Searchable']
	    ),
            'Min' => array(
    ...
    function saveItem( $aData )
    {
		...
		//Searchable
		$aUpdate['Searchable'] = ( isset( $aData['Searchable'] ) and $aData['Searchable'] == 'yes' ) ? 1 : 0;
