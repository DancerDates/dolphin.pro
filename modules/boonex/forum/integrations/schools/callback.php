...
$f->getUserPerm = 'getUserPermSchools';


function getUserPermSchools ($sUser, $sType, $sAction, $iForumId) {

    global $logged;

    $iMemberId = $logged['member'] ? $_COOKIE['memberID'] : 0;

    $aPerm = BxDolService::call('schools', 'get_forum_permission', array ($iMemberId, $iForumId));
