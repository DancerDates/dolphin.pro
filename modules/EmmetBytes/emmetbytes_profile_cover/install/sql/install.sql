...
VALUES (NULL , 'profile', '', 'EmmetBytes Profile Cover', 'eb_profile_cover', '0', '0', 'PHP', "return BxDolService::call('ebProfileCover', 'get_profile_cover');", '0', '0', 'memb', '0');

-- sys_injections
--INSERT INTO `sys_injections` (`id`, `name`, `page_index`, `key`, `type`, `data`, `replace`, `active`) 
--VALUES (NULL, 'eb_profile_cover', '0', 'injection_eb_profile_cover', 'php', "return BxDolService::call('ebProfileCover', 'get_profile_cover');", '0', '1');
