...
class BxPCheckRequest extends BxDolRequest {
    ...
    public static function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_pcheck_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxPCheckRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);