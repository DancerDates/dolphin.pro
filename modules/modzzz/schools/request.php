...
class BxSchoolsRequest extends BxDolRequest {
    ...
    public static function processAsAction($aModule, &$aRequest, $sClass = "Module") {
        ...
        $GLOBALS['oTopMenu']->setCustomSubActions($aVars, 'modzzz_schools_title', false);

        return BxDolRequest::processAsAction($aModule, $aRequest, $sClass);
    }
}

BxSchoolsRequest::processAsAction($GLOBALS['aModule'], $GLOBALS['aRequest']);