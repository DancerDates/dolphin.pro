...
class BxSchoolsFormEdit extends BxSchoolsFormAdd {
    ...
    function __construct ($oMain, $iProfileId, $iEntryId, &$aDataEntry) {
        ...
        $this->aInputs['categories'] = $oCategories->getGroupChooser ('modzzz_schools', (int)$iProfileId, true, $aDataEntry['categories']); 
