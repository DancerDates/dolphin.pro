...
class BxSchoolsCoursesCmts extends BxTemplCmtsView {
    ...
    function isPostReplyAllowed () {
        ...
        return $oMain->isAllowedCommentsSubProfile($oMain->_oDb->_sTableCourses, $aCourseEntry);
    }

    function isEditAllowedAll () {
        $oMain = $this->getMain(); 
		$aCourseEntry = $oMain->_oDb->getCoursesEntryById($this->getId ());
        $aDataEntry = $oMain->_oDb->getEntryById($aCourseEntry['school_id']);
