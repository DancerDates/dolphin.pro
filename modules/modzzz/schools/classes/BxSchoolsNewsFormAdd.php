...
class BxSchoolsNewsFormAdd extends BxDolFormMedia {
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'desc' => array(
                    'type' => 'textarea',
                    'name' => 'desc',
                    'caption' => _t('_modzzz_schools_form_caption_details'),
                    'required' => true,
                    'html' => 2,
                    'checker' => array (
                        'func' => 'length',
                ...
                'allow_view_news_to' => $GLOBALS['oBxSchoolsModule']->_oPrivacy->getGroupChooser($iProfileId, 'schools', 'view'),
