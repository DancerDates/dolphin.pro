...
class BxSchoolsNewsPageBrowse extends BxDolTwigPageMain {
    ...
    function __construct(&$oMain, $sUri) {
		...
		parent::__construct('modzzz_schools_news_browse', $oMain);
	}
    ...
    function getBlockCode_Browse () {
        ...
        $this->oTemplate->addCss(array('unit.css','twig.css'));
    ...
    function getBlockCode_BrowseSiteNews () {
 
		return; //block is removed from functionality
