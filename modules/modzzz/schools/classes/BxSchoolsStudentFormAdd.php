...
class BxSchoolsStudentFormAdd extends BxDolFormMedia {
    ...
    function __construct ($oMain, $iProfileId, $iSchoolId = 0, $iEntryId = 0, $iThumb = 0) { 
		...
		$aStudentEntry = ($iEntryId) ? $this->_oDb->getStudentEntryById($iEntryId) : array();
        ...
        $aInputPrivacyComment = $GLOBALS['oBxSchoolsModule']->_oPrivacy->getGroupChooser($this->_oMain->_iProfileId, 'schools', 'comment');
        ...
        $aInputPrivacyRate = $GLOBALS['oBxSchoolsModule']->_oPrivacy->getGroupChooser($this->_oMain->_iProfileId, 'schools', 'rate');
        ...
        $aInputPrivacyUploadPhotos = $this->_oMain->_oPrivacy->getGroupChooser($this->_oMain->_iProfileId, 'schools', 'upload_photos');
        ...
        $aCustomForm = array(
            ...
            'inputs' => array(
                ...
                'title' => array(
                    'type' => 'text',
                    'name' => 'title',
                    'caption' => _t('_modzzz_schools_form_caption_student_name'),
                    'value' => $sFullName,
                    'required' => true, 
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(1,100),
                        'error' => _t ('_modzzz_schools_form_err_student_name'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'year_entered' => array(
                    'type' => 'text',
                    'name' => 'year_entered',
                    'caption' => _t('_modzzz_schools_form_caption_year_entered'),
                    'required' => true, 
                    'checker' => array (
                        'func' => 'length',
                        'params' => array(1,100),
                        'error' => _t ('_modzzz_schools_form_err_year_entered'),
                    ),
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
                ...
                'year_left' => array(
                    'type' => 'text',
                    'name' => 'year_left',
                    'caption' => _t('_modzzz_schools_form_caption_year_left'),
                    'required' => false,  
                    'db' => array (
                        'pass' => 'Xss', 
                    ),
				...
				'membership_type' => array(
                    ...
                    'caption' => _t('_modzzz_schools_form_caption_membership_type'),
                    'values' => array(
						'student' => _t('_modzzz_schools_option_student'),
						'alumni' => _t('_modzzz_schools_option_alumni'),
					),
                    'db' => array (
                        'pass' => 'Xss' 
                    ) 
                ...
                'allow_view_student_to' => $GLOBALS['oBxSchoolsModule']->_oPrivacy->getGroupChooser($this->_oMain->_iProfileId, 'schools', 'view'),
