...
$eseguiverificaphotodeluxe=mysqli_query($verificaphotodeluxe);
$numerophotodeluxe=mysqli_num_rows($eseguiverificaphotodeluxe);
...
{ 
 ...
 $eseguiintregazionepdx=mysqli_query($integrazionepdx);
 $rowintegrazionepdx=mysqli_fetch_assoc($eseguiintregazionepdx);
...
$queryverifica_exe=mysqli_query($queryverifica);
$numero_ver_group=mysqli_num_rows($queryverifica_exe);
...
if ($mainmenuvar=="ON")
{
 ...
 if ($amiciset=="ON") echo '<div id="rigamenu1"><div class="leftspace"><i class="sys-icon user"></i><a href="viewFriends.php?iUser=' . $ottieniID . '" class="titleitem">'._t('_ibdw_1col_friends').'</a>'.$spaziatorefriend.'<b>'.$contaamici.'</b></div></div></div>';
 ...
 if ($accounteditvar=="ON")
 {
  ...
  if($avaset=='ON') echo '<div id="rigamenu1"><div class="leftspace"><i class="sys-icon edit"></i><a href="'.$avatarurl.'" class="titleitem">'._t('_ibdw_1col_avatar').'</a></div></div>';
