...
class profilecoverDb extends BxDolModuleDb 
{
 var $_oConfig;
 var $sTablePrefix;
 ...
 */
 ...
 function profilecoverDb(&$oConfig) 
 {
 ...
 {
  return $this->getOne("SELECT `ID` FROM `sys_options_cats` WHERE `name` = 'Profile Cover' LIMIT 1");
 }
 
 function removeOldFiles()
 {//remove files uploaded more than 1 hour ago
  $folderName=BX_DIRECTORY_PATH_MODULES."ibdw/profilecover/temp/files";
  ...
  $thumbfolderName=BX_DIRECTORY_PATH_MODULES."ibdw/profilecover/temp/files/thumbnail";
