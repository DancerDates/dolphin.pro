...
function _getLoggedIdRf() {
  return (int)$_COOKIE['memberID'];
}

$sMembFoldPath = $sMembFoldRelativePath = $sMembFoldThumbsRelativePath = '';
$_iVisitorID = _getLoggedIdRf();
if($_iVisitorID) {
  $sMembFoldPath = 'modules/andrew/tm4/images/' . $_iVisitorID . '/';
  $sMembFoldRelativePath = '../../../images/' . $_iVisitorID . '/';
  $sMembFoldThumbsRelativePath = '../../../images/' . $_iVisitorID . '/thumbs/';
}
...
$base_url = BX_DOL_URL_ROOT;
$upload_dir = $sMembFoldPath; //'/source/'; // path from base_url to base of upload folder (with start and final /)
$current_path = $sMembFoldRelativePath; //'../source/'; // relative path from filemanager folder to upload folder (with final /)
//thumbs folder can't put inside upload folder
$thumbs_base_path = $sMembFoldThumbsRelativePath; //'../thumbs/'; // relative path from filemanager folder to thumbs folder (with final /)
