$( document ).ready(function() {
	...
	function orderProvider(order) {
		$.ajax({
			type : "POST",
			url : site_url+"m/social_inviter/ajax_mode/order_network",
	...
	function enableProvider(network_name, status) {
		...
		$.ajax({
			type : "POST",
			url : site_url+"m/social_inviter/ajax_mode/status_network",
	...
	jQuery.fn.iphoneSwitch = function(start_state, switched_on_callback,switched_off_callback) {
		...
		var settings = {
			mouse_over : 'pointer',
			mouse_out : 'default',
			switch_on_container_path : site_url+'modules/sandklock/social_inviter/templates/base/images/iphone_switch_container_off.png',
			switch_off_container_path : site_url+'modules/sandklock/social_inviter/templates/base/images/iphone_switch_container_off.png',
			switch_path : site_url+'modules/sandklock/social_inviter/templates/base/images/iphone_switch.png',
			switch_height : 27,
			switch_width : 94
		};
