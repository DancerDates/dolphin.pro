...
<div style="padding-left: 14px; padding-right: 4px; padding-top: 4px; padding-bottom: 4px"><a target="_top" href="break_frame.php?m=<?php echo $m;?>&p=<?php echo $p;?>&t=<?php echo $t;?>">Click here to switch back to previous admin and go back to Deanos Tools.</a></div>
</body>
</html>
