...
$base_url="http://locolhost/"; //url base of site if you want only relative url leave empty
$upload_dir = '/media/filemanager/'; // path from base_url to upload base dir
$current_path = '../../../../media/filemanager/'; // relative path from filemanager folder to upload files folder
